...
class AddCustomerScreen extends StatefulWidget {
  final Map<String, dynamic>? customer; // Cliente opcional para editar
...
class _AddCustomerScreenState extends State<AddCustomerScreen> {
  ...
  void initState() {
    ...
    // Si se está editando un cliente, inicializa los valores del formulario
  ...
  Future<void> _saveCustomer() async {
    if (_formKey.currentState!.validate()) {
      ...
      if (isEditing) {
        // Si es edición, añade el id del cliente al mapa
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(isEditing ? 'Cliente editado correctamente' : 'Cliente agregado correctamente')),
      );
